...
function Clickable() {
	...
	this.color = "#AAEBFF";		//Background color of the clickable
	this.cornerRadius = 30;		//Corner radius of the clickable
	this.strokeWeight = 3;		//Stroke width of the clickable
	this.stroke = "#D068BD";	//Border color of the clickable
	this.text = "Press Me";		//Text of the clickable
	this.textColor = "#D068BD";	//Color for the text shown
	this.textSize = 25;		//Size for the text shown
